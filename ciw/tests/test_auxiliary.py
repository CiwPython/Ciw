...
class TestAuxiliary(unittest.TestCase):
    ...
    @given(
        choices=lists(integers(min_value=0, max_value=10000), min_size=1, max_size=100),
    ...
    def test_randomchoice(self):
        ...
        self.assertEqual(
            choice_counts, {1: 79, 2: 49, 3: 14, 4: 22, 5: 11, 6: 11, 7: 5, 8: 9}
        )
        ...
        choice_counts = Counter(choices)
        self.assertEqual(
            choice_counts, {"B": 34, "Ch": 83, "Dd": 68, "F": 26, "Ff": 31, "Ng": 58}
        )
