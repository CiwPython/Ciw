...
class TestScheduling(unittest.TestCase):
    def test_change_shift_method(self):
        ...
        N.change_shift()
        self.assertEqual([str(obs) for obs in N.servers], ["Server 4 at Node 1"])
        ...
        self.assertEqual(
            [obs.offduty for obs in N.servers], [True, False, False, False]
        )
    ...
    def test_take_servers_off_duty_method(self):
        ...
        self.assertEqual(
            [obs.offduty for obs in N.servers], [False, False, False, False]
        )
    ...
    def test_full_preemptive_simulation(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    schedule=[[1, 15], [0, 17], [2, 100]], preemption="resample"
                )
            ],
        )
        Q = ciw.Simulation(N)
        ...
        N = ciw.create_network(
            ...
            routing=[[0.0]],
            number_of_servers=[
                ciw.Schedule(schedule=[[1, 15], [0, 17], [2, 100]], preemption="resume")
            ],
        )
        Q = ciw.Simulation(N)
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    schedule=[[4, 12.5], [0, 17], [1, 100]], preemption="resume"
                )
            ],
        )
        Q = ciw.Simulation(N)
    ...
    def test_overtime(self):
        N = ciw.create_network(
            arrival_distributions=[
                ciw.dists.Sequential([1.0, 0.0, 0.0, 8.0, 0.0, 3.0, 10000.0])
            ],
            service_distributions=[
                ciw.dists.Sequential([5.0, 7.0, 9.0, 4.0, 5.0, 5.0])
            ],
            number_of_servers=[
                ciw.Schedule(
                    schedule=[[3, 7.0], [2, 11.0], [1, 20.0]], preemption=False
                )
            ],
        )
        Q = ciw.Simulation(N)
    ...
    def test_preemptive_schedules_resume_options(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(schedule=[[1, 5], [0, 9], [1, 100]], preemption="restart")
            ],
        )
        Q = ciw.Simulation(N)
        ...
        N = ciw.create_network(
            ...
            service_distributions=[ciw.dists.Sequential([10, 20])],
            number_of_servers=[
                ciw.Schedule(schedule=[[1, 5], [0, 9], [1, 100]], preemption="resume")
            ],
        )
        Q = ciw.Simulation(N)
        Q.simulate_until_max_time(40)
        ...
        N = ciw.create_network(
            ...
            service_distributions=[ciw.dists.Sequential([10, 20])],
            number_of_servers=[
                ciw.Schedule(schedule=[[1, 5], [0, 9], [1, 100]], preemption="resample")
            ],
        )
        Q = ciw.Simulation(N)
        Q.simulate_until_max_time(40)
    ...
    def test_resuming_interruption_after_blockage(self):
        N = ciw.create_network(
            arrival_distributions=[
                ciw.dists.Sequential([5, float("inf")]),
                ciw.dists.Sequential([1, float("inf")]),
            ],
            service_distributions=[
            ...
            number_of_servers=[
                ciw.Schedule(schedule=[[1, 8], [0, 200]], preemption="resume"),
                1,
            ],
        ...
        N = ciw.create_network(
            arrival_distributions=[
                ciw.dists.Sequential(
                    [0.3, 0.2, 0.2, 0.5, 0.1, 0.5, 0.8, 0.1, 0.4, float("inf")]
                )
            ],
            service_distributions=[ciw.dists.Deterministic(0.5)],
            number_of_servers=[
                ciw.Slotted(slots=[1, 2, 3, 4], slot_sizes=[3, 2, 5, 3])
            ],
        )
        Q = ciw.Simulation(N)
    ...
    def test_slotted_services_repeat(self):
        ...
        N = ciw.create_network(
            arrival_distributions=[
                ciw.dists.Sequential(
                    [0.7, 0.7, 1.2, 0.3, 1.4, 1.2, 0.6, 8.9, float("inf")]
                )
            ],
    ...
    def test_noncapacitated_slotted_services_with_overruns(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Slotted(slots=[1, 3, 5, 11], slot_sizes=[2, 1, 1, 1])
            ],
        )
        Q = ciw.Simulation(N)
        Q.simulate_until_max_time(20)
    ...
    def test_slotted_services_capacitated(self):
        ...
        N = ciw.create_network(
            arrival_distributions=[
                ciw.dists.Sequential([0.5, 0.6, 0.4, 0.3, 0.8, float("inf")])
            ],
            service_distributions=[ciw.dists.Sequential([0.2, 0.2, 1.2, 0.2, 0.5])],
            number_of_servers=[
                ciw.Slotted(slots=[2, 3], slot_sizes=[4, 1], capacitated=False)
            ],
        )
        Q = ciw.Simulation(N)
        ...
        N = ciw.create_network(
            ...
            service_distributions=[ciw.dists.Sequential([0.2, 0.2, 1.2, 0.2, 0.5])],
            number_of_servers=[
                ciw.Slotted(slots=[2, 3], slot_sizes=[4, 1], capacitated=True)
            ],
        )
        Q = ciw.Simulation(N)
        Q.simulate_until_max_time(10)
    ...
    def test_invalid_preemption_options(self):
        self.assertRaises(
            ValueError,
            lambda: ciw.Schedule(schedule=[[2, 10], [1, 12]], preemption="something"),
        )
        self.assertRaises(
            ValueError,
            lambda: ciw.Slotted(
                slots=[2, 3], slot_sizes=[4, 1], capacitated=False, preemption="resume"
            ),
        )
        self.assertRaises(
            ValueError,
    ...
    def test_slotted_services_capacitated_preemption(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Slotted(slots=[4, 11], slot_sizes=[3, 1], capacitated=True)
            ],
        )
        Q = ciw.Simulation(N)
